class TaperedCylinderColliderComponent : ColliderComponent {
    [Editable]
    private Physics::ShapeTaperedCylinder shape;

    TaperedCylinderColliderComponent(ICompositer@ parent = null) {
        super(parent);
    }
